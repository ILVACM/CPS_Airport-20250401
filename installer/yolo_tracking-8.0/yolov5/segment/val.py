...
Usage:
    $ bash data/script/get_coco.sh --val --segments  # download COCO-segments val split (1G, 5000 images)
...
def run(
        ...
        name='aug4',  # save to project/name
...
def parse_opt():
    ...
    parser.add_argument('--name', default='aug4', help='save to project/name')
